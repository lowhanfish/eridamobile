    ...
    return (
        <View style={[styles.bottomBar, { paddingBottom: insets.bottom }]}>
            <View style={styles.bottomBarContainer}>
                ...
                <View style={[styles.containerIconBottomBar]}>
                    <TouchableOpacity onPress={() => navigation.navigate("MainPage", { screen: "DataInformation" })} style={styles.btnMenu}>
                ...
                <View style={[styles.containerIconBottomBar]}>
                    <TouchableOpacity onPress={() => navigation.navigate("MainPage", { screen: "DocumentsList" })} style={styles.btnMenu}>
                ...
                <View style={[styles.containerIconBottomBar]}>
                    <TouchableOpacity onPress={() => navigation.navigate("MainPage", { screen: "Setting" })} style={styles.btnMenu}>
