...
const DATA_CATEGORIES = [
{
        ...
        icon: require('../assets/images/riset.png'),
        color: '#E3F2FD',
        route: 'DataRiset',
    },
    {
    ...
    },
{
    ...
    },
    {
        ...
        icon: require('../assets/images/teknologi.png'),
        color: '#F3E5F5',
        route: 'DataTeknologi',
    },
    {
    ...
    },
    {
        id: 'iid',
        title: 'Data IID',
        description: 'Data indeks inovasi daerah',
        icon: require('../assets/images/inovda.png'),
        color: '#E0F7FA',
        route: 'DataIID',
    },
    {
        id: 'ipkd',
        title: 'Data IPKD',
        description: 'Data Indeks Pengelolaan Keuangan Daerah',
        icon: require('../assets/images/ipkd.png'),
        color: '#ECEFF1',
        route: 'DataIPKD',
    },
    {
        ...
        icon: require('../assets/images/idsd.png'),
        color: '#FFF8E1',
        route: 'DataIDSD',
    },
    {
        ...
        icon: require('../assets/images/haki.png'),
        color: '#FBE9E7',
        route: 'DataHaKI',
    },
    {
