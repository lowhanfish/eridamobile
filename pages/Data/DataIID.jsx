...
const DataIID = () => {
    ...
    const getData = async () => {
        ...
        try {
            ...
            console.log("Chart IID error:", err);
            setChartData([]);
        } finally {
                ...
                <View style={{ flex: 1, paddingBottom: 72 }}>
                    <View style={stylex.pageTitleContainer}>
                        <View style={[stylex.pageTitleItemContainer, { justifyContent: 'center' }]}>
                            <View >
                                <Text style={stylex.textTitleList}>DATA IID</Text>
                                <Text style={stylex.textSubTitleList2}>Indeks Inovasi Daerah</Text>
                            </View>
                        </View>
                    </View>
                    ...
                    <View style={styles.chartContainer}>
                        <Text style={styles.chartTitle}>Nilai IID per Tahun</Text>
                        ...
                        {chartData.length > 0 && (
                            <View style={styles.legendContainer}>
                                <Text style={styles.legendText}>
                                    * Nilai rata-rata Indeks Inovasi Daerah per tahun
                                </Text>
                            </View>
                        )}
                    </View>
                    ...
                    <View style={styles.descriptionCard}>
                        <Text style={styles.descriptionTitle}>Tentang IID</Text>
                        <Text style={styles.descriptionText}>
                            Indeks Inovasi Daerah (IID) adalah ukuran penilaian inovasi yang dilakukan oleh pemerintah daerah. 
                            Nilai IID menunjukkan tingkat keberhasilan inovasi dalam penyelenggaraan pemerintahan daerah.
                        </Text>
                    </View>
